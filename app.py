...
def build_excel(records: list, meta: dict, monday: date) -> bytes:
    ...
    for lbl, c1, c2, bg, fg in [
        ("KOSHA 폭염 단계", 1,  2,  C_DARK,   C_WHITE),
        ("■ 관심  31°C~",   3,  4,  "34C759", C_WHITE),
        ("■ 주의  33°C~",   5,  6,  "FFCC00", C_INK),
        ("■ 경고  35°C~",   7,  8,  "FF9500", C_WHITE),
